(function ($) {
    ...
    $.easyui.grid = function () {
        ...
        return {
            ...
            insert: function (row, gridId, fnAddBefore) {
                ///	<summary>
                ///	创建新行
                ///	</summary>
                ///	<param name="row" type="String">
            ...
            deleteByGridWithSave: function (gridId) {
                var grid = $.easyui.getGrid(gridId);
                ...
                $.messager.confirm('警告', $.easyui.deleteTipWithSave, function (r) {
                    if (r) {
    ...
    $.easyui.treegrid = function () {
        ...
        return {
            ...
            deleteByTreeGridWithSave: function (gridId) {
                var grid = $.easyui.getGrid(gridId);
                var data = grid.datagrid('getSelected');
                if (!data) {
                    $.easyui.warn($.easyui.deleteNotSelectedMessage);
