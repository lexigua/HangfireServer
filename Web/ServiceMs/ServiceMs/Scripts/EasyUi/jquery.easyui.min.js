...
opts.tab.append("<a href=\"javascript:void(0)\" title=" + opts.title + " class=\"tabs-inner\">" + "<span class=\"tabs-title\"></span>" + "<span class=\"tabs-icon\"></span>" + "</a>");
...
var pid = $(e.target).closest("div.datagrid-view,div.combo-panel").find(".datagrid-f").attr("id");
if (pid == "allocationGrid") {
$("#" + pid).propertygrid("selectRow", $(e.target).parent().parent().attr("datagrid-row-index"));
}
