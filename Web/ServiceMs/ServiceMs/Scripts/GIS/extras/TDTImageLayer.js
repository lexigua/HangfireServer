define(["dojo/_base/declare", "esri/layers/tiled"], function (declare) {
    return declare(esri.layers.TiledMapServiceLayer, {
        constructor: function () {
            ...
            //this.initialExtent = (this.fullExtent = new esri.geometry.Extent(102.988305, 30.091518, 104.889483, 31.437773, this.spatialReference));
            //this.initialExtent = (this.fullExtent = new esri.geometry.Extent(101.683654, 30.091518, 106.141357, 32.061604, this.spatialReference));
        ...
        getTileUrl: function (level, row, col) {
            ...
            // return "http://192.168.2.204:8020/mapproxy.ashx?type=image&x=" + row + "&y=" + col + "&z=" + level;
            //return "http://192.168.2.155:8033/mapproxy.ashx?type=zhuanti&x=" + row + "&y=" + col + "&z=" + level;

            return "http://t" + row % 8 + ".tianditu.cn/img_c/wmts?service=wmts&request=GetTile&version=1.0.0&LAYER=img&tileMatrixSet=c&TileMatrix=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&FORMAT=tiles";
           
            //return "http://t0.tianditu.com/DataServer?T=img_w" + "&x=" + col + "&y=" + row + "&l=" + level;
            //return "http://118.112.190.75:8891/iMap/iMapServer/defaultrest/services/SCTileMap_DOM_DOM/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cva&STYLE=default&TILEMATRIXSET=c&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&FORMAT=tiles";
...
//                },
//                "lods": [
//                  { "level": 2, "resolution": 0.251528279553466, "scale": 1.0E8 },
//                  { "level": 3, "resolution": 0.125764139776733, "scale": 5.0E7 },
//                  { "level": 4, "resolution": 0.0628820698883665, "scale": 2.5E7 },
//                  { "level": 5, "resolution": 0.0251528279553466, "scale": 1.0E7 },
//                  { "level": 6, "resolution": 0.0125764139776733, "scale": 5000000.0 },
//                  { "level": 7, "resolution": 0.00628820698883665, "scale": 2500000.0 },
//                  { "level": 8, "resolution": 0.00251528279553466, "scale": 1000000.0 },
//                  { "level": 9, "resolution": 0.00125764139776733, "scale": 500000.0 }
//                  //{ "level": 10, "resolution": 0.001373291015625, "scale": 577143.73644287116 },
//                  //{ "level": 11, "resolution": 0.0006866455078125, "scale": 288571.86822143558 },
//                  //{ "level": 12, "resolution": 0.00034332275390625, "scale": 144285.93411071779 },
//                  //{ "level": 13, "resolution": 0.000171661376953125, "scale": 72142.967055358895 },
...
//           // return "http://118.112.190.75:8891/iMap/iMapServer/defaultrest/services/SCTileMap_DOM_DOM/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cva&STYLE=default&TILEMATRIXSET=c&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&FORMAT=tiles";
//            return "http://112.74.101.152:8090/iserver/services/map-FZY---FuBen/wmts100?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&LAYER=风区分区专题图&STYLE=default&FORMAT=image/png&TILEMATRIXSET=GlobalCRS84Scale_风区分区专题图&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col;
//        }
//    });
//});